...
for k in range(epochs):
 #np.random.shuffle(modes)
	nu_max=np.asarray(np.arange(1980,3000,4))
...
df.to_csv('/home/rakesh/sandbox_Code/Code_randtrip/Results/cost.csv')
f=file('/home/rakesh/sandbox_Code/Code_randtrip/Results/nnparams.sav','wb')
